...
var _user$project$Models$Date = F3(
	function (a, b, c) {
		return {year: a, month: b, day: c};
	});
var _user$project$Models$BlogModel = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
...
var _user$project$Models$init_model = function (flag) {
	return {
...
var _user$project$Msgs$OnFetchBlog = function (a) {
...
var _user$project$Commands$date_decoder = A3(
	...
	A3(
		...
		A3(
			...
			'year',
			_elm_lang$core$Json_Decode$string,
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Models$Date))));
var _user$project$Commands$main_decoder = A4(
...
var _user$project$Commands$fetch_blog = function (blog_path) {
	return A2(
		_elm_lang$core$Platform_Cmd$map,
		_user$project$Msgs$OnFetchBlog,
...
var _user$project$Commands$fetch_blogs = A2(
	...
	_krisajenkins$remotedata$RemoteData$sendRequest(
		A2(_elm_lang$http$Http$get, _user$project$Commands$blogs_url, _user$project$Commands$blogs_decoder)));

var _user$project$Ports$set_title = _elm_lang$core$Native_Platform.outgoingPort(
	'set_title',
	function (v) {
		return v;
	});
...
var _user$project$Routing$url2msgs = function (location) {
	return {
		ctor: '::',
		_0: _user$project$Msgs$OnLocationChange,
		_1: {ctor: '[]'}
	};
};
var _user$project$Routing$delta2url = F2(
	function (previous, current) {
		var url = current.settings.location.href;
		var _p0 = _rgrempel$elm_route_url$RouteUrl_Builder$path(
			_rgrempel$elm_route_url$RouteUrl_Builder$fromUrl(url));
		if ((_p0.ctor === '::') && (_p0._0 === '')) {
			return A2(
				_elm_lang$core$Maybe$map,
	...
	function (msg, model) {
		...
		switch (_p0.ctor) {
			case 'OnFetchBlogs':
				...
				var _p1 = _p4;
				if (_p1.ctor === 'Success') {
					var _p2 = A2(new_setting, 'Nasy Land', _user$project$Models$Normal);
					var settings = _p2._0;
					var title = _p2._1;
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{blogs: _p4, settings: settings}),
						_1: _user$project$Ports$set_title('Nasy Land')
					};
				} else {
					var _p3 = A2(new_setting, 'Nasy Land', _user$project$Models$NotFoundRoute);
					var settings = _p3._0;
					var title = _p3._1;
					return {
						ctor: '_Tuple2',
			...
			case 'OnFetchBlog':
				...
				switch (_p5.ctor) {
					case 'Success':
						var _p6 = A2(new_setting, _p5._0.title, _user$project$Models$BlogRoute);
						var settings = _p6._0;
						var title = _p6._1;
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{blog: _p9, settings: settings}),
							_1: _user$project$Ports$set_title(title)
						};
					case 'Failure':
						var _p7 = A2(new_setting, '404 Not Found', _user$project$Models$NotFoundRoute);
						var settings = _p7._0;
						var title = _p7._1;
						return {
							ctor: '_Tuple2',
					...
					default:
						var _p8 = A2(new_setting, old_settings.title, _user$project$Models$NotFoundRoute);
						var settings = _p8._0;
						var title = _p8._1;
						return {
							ctor: '_Tuple2',
			...
			case 'OnLocationChange':
				var old_settings = model.settings;
				var settings = function (route) {
					return _elm_lang$core$Native_Utils.update(
						old_settings,
						{route: route});
				};
				var new_model = function (route) {
					return _elm_lang$core$Native_Utils.update(
						model,
						{
				...
				var url = model.settings.location.href;
				var _p10 = _rgrempel$elm_route_url$RouteUrl_Builder$path(
					_rgrempel$elm_route_url$RouteUrl_Builder$fromUrl(url));
				if (_p10.ctor === '[]') {
					return {
						ctor: '_Tuple2',
						_0: new_model(_user$project$Models$Normal),
						_1: _user$project$Commands$fetch_blogs
					};
				} else {
					switch (_p10._0) {
						case 'blogs':
						...
						case 'blog':
							return {
								ctor: '_Tuple2',
								_0: new_model(_user$project$Models$BlogRoute),
								_1: _user$project$Commands$fetch_blog(
			...
			case 'SetUrl':
				var _p11 = _rgrempel$elm_route_url$RouteUrl_Builder$path(
					_rgrempel$elm_route_url$RouteUrl_Builder$fromUrl(_p0._0));
				if (_p11.ctor === '[]') {
					return {ctor: '_Tuple2', _0: model, _1: _user$project$Commands$fetch_blogs};
				} else {
					switch (_p11._0) {
						case 'blogs':
							return {ctor: '_Tuple2', _0: model, _1: _user$project$Commands$fetch_blogs};
						case 'blog':
							return {
								...
								_0: model,
								_1: _user$project$Commands$fetch_blog(
									A2(_elm_lang$core$String$join, 'blog_url', _p11._1))
							};
						default:
							return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
					}
			...
			A2(
					...
					}),
				{
					...
					_0: A2(
						_elm_lang$html$Html_Attributes$property,
						'innerHTML',
						_elm_lang$core$Json_Encode$string(html_string)),
					_1: {ctor: '[]'}
				},
				attributes),
			{ctor: '[]'});
	});
var _user$project$Views$tag_li = F2(
	function (prefix, tag) {
		return A2(
			_elm_lang$html$Html$li,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('tags-list-li'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$a,
					{
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('tags-list-li-a'),
							_1: {ctor: '[]'}
						}
					},
					{
...
var _user$project$Views$tag_list = F2(
	function (prefix, tags) {
		return A2(
			...
			A3(
				_elm_lang$core$List$map2,
				_user$project$Views$tag_li,
				A2(
					_elm_lang$core$List$repeat,
					_elm_lang$core$List$length(tags),
					prefix),
				tags));
	});
var _user$project$Views$tag_view = function (blog) {
	return A2(
		_elm_lang$html$Html$section,
		{
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('blogs-list-tags'),
				_1: {ctor: '[]'}
			}
		},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('tags-time'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
				...
				_1: {
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('tags-categories'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('tags-tags'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
...
var _user$project$Views$blogs_list_single = function (blog) {
	return {
		ctor: '::',
		_0: A2(
	...
	switch (_p0.ctor) {
		case 'NotAsked':
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('NotAsked'),
					_1: {ctor: '[]'}
				});
		case 'Loading':
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('blogs-list-loading'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Loading Blogs List'),
					_1: {ctor: '[]'}
				});
		case 'Success':
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$id('blogs-list'),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('blogs-list'),
						_1: {ctor: '[]'}
					}
				},
	...
	switch (_p1.ctor) {
		...
		case 'Loading':
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('blog-loading'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Loading Blog'),
					_1: {ctor: '[]'}
				});
		case 'Success':
			return A2(
...
var _user$project$Views$nav_view = function (base) {
	return {
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('header-section-nav nav'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
		...
		default:
			return {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Main H2 Text Other'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: _user$project$Views$notfound,
					_1: {ctor: '[]'}
				}
			};
	}
		...
		_0: A2(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Nasy Land'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('header-section-description description'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Nasy 栽花，养鱼，闲聊的地方～♡'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				_user$project$Views$header_view(model)),
			_1: {
				ctor: '::',
				_0: A2(
					...
					_user$project$Views$main_view(model)),
				_1: {
					ctor: '::',
					_0: A2(
...
var _user$project$Main$init = function (flag) {
	var model = _user$project$Models$init_model(flag);
	return {
		ctor: '_Tuple2',
		_0: model,
		_1: _user$project$Ports$set_title(model.settings.title)
	};
};
var _user$project$Main$main = _rgrempel$elm_route_url$RouteUrl$programWithFlags(
	{init: _user$project$Main$init, view: _user$project$Views$view, update: _user$project$Update$update, subscriptions: _user$project$Main$subscriptions, delta2url: _user$project$Routing$delta2url, location2messages: _user$project$Routing$url2msgs})(
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (hash) {
			return A2(
																					...
																					return A2(
																						...
																						function (username) {
																							return _elm_lang$core$Json_Decode$succeed(
																								{hash: hash, host: host, hostname: hostname, href: href, origin: origin, password: password, pathname: pathname, port_: port_, protocol: protocol, search: search, username: username});
																						},
